 ...
 * Main.java
 *
 * Clase main del proyecto que permite crear objetos Materia y
 * Alumno 
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Agregar 25 alumnos con sus respectivas materias para mostrarlos en la ejecución
        ...
        Alumno alumno3 = new Alumno("José Ernesto Miramontes Hernández", 242487, "Diseño Gráfico", "Enero-Mayo", 5);
        ...
        Alumno alumno7 = new Alumno("Carlos Alberto Martínez Ibarra", 252719, "Ing. Mecatrónica", "Enero-Mayo", 6);
        ...
        Alumno alumno25 = new Alumno("Manuel Romo López", 253080, "Ing. Software", "Enero-Mayo", 4);
        alumno25.getMaterias().add(m15);
        alumno25.getMaterias().add(m16);
        alumno25.getMaterias().add(m13);
        alumno25.getMaterias().add(m12);

        //Añadir cada alumno con sus datos a la lista de alumnos inscritos
        ...
        //Inicializar la interfaz gráfica usando swing
        SwingUtilities.invokeLater(() -> {
            VistaConstancia vista = new VistaConstancia();

            //Registrar la vista como el objeto observador de cada alumno
            ...
            //Habilitar la búsqueda de alumnos
            vista.iniciarBuscador(controlador);
            //Habilitar la selección de alumnos en la tabla
            vista.iniciarSeleccionAlumno(controlador);
            //Hacer visible el Frame de la aplicación
